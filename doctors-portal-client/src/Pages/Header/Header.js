        ...
        <div className= 'max-w-screen-xl p-4 mx-auto'>
          <div className="flex items-center justify-between space-x-4 lg:space-x-10">
            ...
            <Link to='/' className="px-2 py-1 text-sm font-medium text-gray-700 transition-colors duration-200 transform rounded dark:text-black hover:bg-gray-900 hover:text-gray-100 md:mx-2">Home</Link>
                    ...
                    <Link to='/appointment' className="px-2 py-1 text-sm font-medium text-gray-700 transition-colors duration-200 transform rounded dark:text-black hover:bg-gray-900 hover:text-gray-100 md:mx-2">Appointment</Link>
            </nav>
